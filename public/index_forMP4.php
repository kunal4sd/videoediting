...
$keywords_list = $db->rawQuery("select distinct(k.id), k.* from keyword k inner join customer_keyword ck on ck.keyword_id = k.id inner join customer c on c.id = ck.customer_id where c.expiry_date >= now() and k.active = 1 ");
...
$(document).ready(function(){
	...
	<?php if ( @$_POST['channel'] ){ ?>
		...
		url = "https://edit.mediaobserver-me.com/index.php?action=content_list2&tab_id=5a2807b3da695&type=input&_=1512653189172&channel=<?php echo $_POST['channel'];?>&fdate=<?php echo $_POST['fdate']?>&day2=0";
