			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<span class="li-text">
								If You Have any problem call the administrator : 2222
							</span> 
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                                                        <h1><strong>Login</strong> To MediaObserver Admin pages</h1>
                            ...
                            <div class="form-bottom contact-form">
			                    <form role="form" action="checkuser.php" method="post">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="username" placeholder="Username" class="contact-email form-control" id="contact-email">
			                        </div>
			                        <div class="form-group">
