        ...
        a.Chart.prototype.getTable = function(a) {
            ...
            var e = 0,
                ...
                q = function(a, c, f, l) {
					...
					if ( k.indexOf('00:00:00') == -1 && count == 0 && k!='Date' ) {
							userNames.push(k);
					}

					if( k.indexOf('00:00:00') > -1 ){
						curdate = k ;
						arrCursor =0;
						linkK= k;
						count++;
						...
						if( count == 0 ){
							...
							linkK= '<a href="json/dashboard/show_emp_articles_new.php?emp_id='+userNames[arrCursor]+'&periodq=2&act='+h.title.text+'&dateEQ='+curdate+'" class="popup">'+k+'</a>';
							arrCursor++;
						}
					...
					//alert(userNames.toString() );
                    return "\x3c" + a + (f ? " " + f : "") + ' class\x3d"' + c + '"\x3e' + linkK + "\x3c/" + a + "\x3e"
                };
