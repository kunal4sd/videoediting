...
class Xcrud_config
{
    // default connection
/*	
    public static $dbname = 'project'; // Your database name
...
*/
    ...
    public static $dbname = 'moc'; // Your database name
    public static $dbuser = 'office'; // Your database username
    public static $dbpass = 'UFGBsfrhjuj42'; // // Your database password
    public static $dbhost = 'moc.mediaobserver-me.com'; // Your database host, 'localhost' is default.
