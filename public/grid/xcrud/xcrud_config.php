...
*/
    ...
    public static $dbname = 'media_media'; // Your database name
    public static $dbuser = 'app_user'; // Your database username
    public static $dbpass = 'UFGBsfrhjuj42'; // // Your database password
    public static $dbhost = '192.168.1.19'; // Your database host, 'localhost' is default.
