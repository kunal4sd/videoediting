...
$publication_types = $db->rawQuery(' select * from publication_type where id in (1,2,3,4)' );
            ...
            <div class="panel-body">
				<div class="col-md-2" style="padding-left:0px !important">
                  <div class="form-group">
				    ...
				    <input name="publication" type="text" id="publication" placeholder="Name" style="width:100%"  />
                  </div>
                </div>
