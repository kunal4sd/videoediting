...
var WebVideoEditor = function(t) {
    ...
    this.init = function() {
		...
		if ( ac == 'users'){
			...
			}), i = $("#jp_video_0").get(0), $(i).on("loadedmetadata error", function() {
			...
			s = $("#wve-timeline"), o = $("#wve-timeline-range"), $("body").tooltip({
				...
				/* xxxxxx when first load*/
				//a.updateSelectedMedia()	//;
				
				if(check_play){
					a.selectMedia(i.title,'input')
					check_play = false
				...
				/*to change timebar time and make it walk*/
				n && (s.slider("option", {
					value: 1e3 * this.currentTime
				}), $("#wve-editor-player-time-current").text(a.secondsToTime(this.currentTime)))
        ...
        $(document.body).on("click", '[data-toggle="action"]', function(t) {
            ...
            switch (o[0]) {
                ...
                case "import":
                    ...
                    break;
                case "select-media":
					//$('div[aria-label="First group"]').css('visibility','hidden'); 
					//By Rami
	...
	var n = _.template($("#ModifyPublicationModalTemplate").html());
        ...
        if ("episode" != t || r[i]) {
			...
			if ( r[i] ){
				var ra_template = 'videoPreviewModal2Template';
				var ra_modal = 'videoPreviewModal2';
			} else {
				var ra_template = 'videoPreviewModalTemplate';
				var ra_modal = 'videoPreviewModal';
				
			}
			
			var n, s = "";
			"episode" == t && (n = r[i], s = n.url);
			var o = _.template($("#"+ra_template).html());
		...
		//n ='input'
		//t= '858.2017_11_06-00:19:56';//858.2017_11_22-00:29:56
        ...
        i.pause(), $.ajax({
            ...
            if (t.success) {
                ...
                //i.find(".list-group-item").removeClass("active"), i.find('.btn-link[data-id="' + t.data.id + '"]').parent("li").addClass("active"), 
				e = t.data, 
				a.updateSelectedMedia()
        ...
        o.modal("show").on("hidden.bs.modal", function(t) {
            ...
            t.preventDefault(), o.find(".js-button-submit").prop("disabled", !0), i = $('input[name="title"]', o).val(), n = a.serializeForm($("form", o)), 
			s = a.getProjectData();
            var e = $(this);
			var pid = getParameterByName('tab_id');
        ...
        if (r && r.length > 0) r.forEach(function(e) {
            ...
            var i = {
                id: '858.2017_11_06-00:19:56'//e.id
            };
