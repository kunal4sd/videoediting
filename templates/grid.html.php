...
$pupID = 10;
$pubInfo = $db2->rawQueryOne(' select * from publication where id  ='.$pupID );

$grids = $db2->rawQuery(' select * from grids where publication_id ='.$pupID );
$callURL = 'grid/json/grid/get_datatable.php?gid=';

?>

    <link href="grid/assets/css/bootstrap.css" rel="stylesheet" />
    <link href="grid/assets/css/font-awesome.css" rel="stylesheet" />
    <link href="grid/assets/css/custom.css" rel="stylesheet" />
    <link href="grid/assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
	<link rel="stylesheet" href="grid/assets/css/bootstrap-select.min.css">
	<link href="grid/assets/css/animate.css" rel="stylesheet" />
	<link href="grid/assets/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
    <link href="grid/assets/css/select2.css" rel="stylesheet" />
	<link href="grid/assets/css/popup.css" rel="stylesheet" />
	<link href="grid/assets/css/jquery-ui.min.css" rel="stylesheet" />
	<link href="grid/assets/css/daterangepicker.css" rel="stylesheet" />
	<link href="grid/assets/css/timepicker.css" rel="stylesheet" />
	<link href="grid/assets/js/include/ui-1.10.0/ui-lightness/jquery-ui-1.10.0.custom.min.css" rel="stylesheet" />
	<link href="grid/assets/js/jquery.ui.timepicker.css" rel="stylesheet" />
	
	<link href="grid/assets/js//jquery-ui-timepicker-addon.css" rel="stylesheet" />
	<link href="grid/assets/css/jquery.ptTimeSelect.css" rel="stylesheet" />
	
	
    
	<script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>

    <script src="grid/assets/js/jquery-1.10.2.js"></script>
    <script src="grid/assets/js/bootstrap.min.js"></script>
    <script src="grid/assets/js/dataTables/jquery.dataTables.js"></script>	
    <script src="grid/assets/js/bootstrap-select.min.js"></script>	
    <script src="grid/assets/js/jquery.chained.remote.js"></script>
	<script src="grid/assets/js/bootstrap-datetimepicker.min.js"></script>
	<script src="grid/assets/js/bootstrap-notify.min.js"></script>
    <script src="grid/assets/js/select2.js"></script>
	<script src="grid/assets/js/jquery.popup.min.js"></script>
	<script src="grid/assets/js/jquery.form-validator.min.js"></script>
	<script src="grid/assets/js/jquery-ui.min.js"></script>
	<script src="grid/assets/js/moment.min.js"></script>
	<script src="grid/assets/js/timepicker.js"></script>
	<script src="grid/assets/js/daterangepicker.js"></script>
	<!-- script src="grid/assets/js/jquery.ui.timepicker.js"></script -->
	<script src="grid/assets/js/jquery-ui-timepicker-addon.js"></script>
	<script src="grid/assets/js/jquery.ptTimeSelect.js"></script>
	
	<style>
	td.details-control {
		background: url('grid/assets/img/editIcon.png') no-repeat center center;
		cursor: pointer;
	}
...
function savegrid(){
	$.ajax({
		url: 'grid/json/grid/savegrid.php', // url where to submit the request
...
function AddEditGrid(id=0){
	...
	if( id > 0 ){
		$.getJSON( "grid/json/grid/getGridInfo.php?id="+id, function( json ) {
...
function AddEditProgram(showID, programID=0){
	...
	if( programID > 0 ){
		...
		$.getJSON( "grid/json/grid/getProgInfo.php?id="+programID, function( json ) {
...
function saveProg(){
		...
		$.ajax({
		url: 'grid/json/grid/saveprog.php', // url where to submit the request
		type : "POST", // type of action POST || GET
		dataType : 'json', // data type
...
function openDatatable(id){
		...
		$('#fulltable'+id+' tbody').on('click', 'td.details-control', function () {
			...
			$.getJSON( "grid/json/grid/get_showTimes.php?sid="+row.data().id, function( json ) {
...
$(document).ready(function() {
	...
	$('select').on('change', function() {
	  <?php if($pupID){ ?>
		var r = confirm("Are you sure you want to change the channel?");
		 if (r == true) {
			 window.location = 'index.php?action=grid&pubID='+this.value ;
		 } else {
			return false; 
		 }
	  <?php } else {?>
    ...
    <div id="page-inner">
	 ...
	 <div class="row">
	  <div class="col-md-5"  >
		<form >
              <div class="col-md-4">
				<select id="channel"   placeholder="channel" name="channel" class="form-control " style="height:30px" >
        ...
        <div class="col-md-7">
          <div class="panel panel-default">
            <div class="panel-heading">
              <?php echo $pubInfo['name_en'];?>  <button type="button" style="float:right; padding:0 10px 0px 10px !important;" onclick="AddEditGrid()" class="btn btn-default">Add Grid</button>
            </div>
