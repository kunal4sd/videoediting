...
<script type="text/template" id="videoPreviewModal2Template">
    <div class="modal fade" id="videoPreviewModal2" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<select multiple  class="chosen-select" name="keyword[]" >
						<?php foreach($keywords_list as $kl){
							$selected = '';//($kl['id']==55) ? 'selected':'';
							echo '<option value="'.$kl['id'].'" '.$selected.'> '.$kl['name_en'].'-'.$kl['name_ar'] .' </option>';
						}?>
					</select>
